...
export default function AdminDashboard() {
  ...
  const { data: externalEmployees = [], isLoading: isLoadingEmployees } =
    useQuery({
  ...
  const getEmployeeName = (userId: string) => {
    ...
    const externalEmployee = (externalEmployees as any[]).find(
      (emp) =>
        emp.user_id === userId ||
        emp.user_id === parseInt(userId) ||
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                <Button
                  variant={
                    activeRequestTab === "Leaves" ? "default" : "outline"
                  }
                  size="sm"
                  className={
                    activeRequestTab === "Leaves"
                ...
                <Button
                  variant={
                    activeRequestTab === "CompOff" ? "default" : "outline"
                  }
                  size="sm"
                  className={
          ...
          <div className="divide-y divide-gray-100">
            {activeRequestTab === "BTO" ? (
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-gray-600">
                  Compensatory off requests will appear here when submitted by
                  employees.
                </p>
              </div>
              ...
              filteredRequests.slice(0, 3).map((request: any) => {
                const employee = (users as any[]).find(
            ...
            <div className="grid grid-cols-7 gap-1">
              {(() => {
                ...
                for (let i = 0; i < 42; i++) {
                  ...
                  const leavesOnThisDay = isCurrentMonth
                    ? approvedRequests.filter((request: any) => {
