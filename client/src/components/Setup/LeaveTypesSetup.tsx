...
export default function LeaveTypesSetup({
  ...
  const handleCreateVariant = (leaveType: any) => {
    ...
    const actualLeaveType = Array.isArray(leaveTypes)
      ? leaveTypes.find((lt: any) => lt.name === leaveType.name)
      : null;
  ...
  const getVariantsForLeaveType = (leaveTypeName: string) => {
    ...
    return (
      leaveVariants.filter(
        (variant: any) => variant.leaveTypeName === leaveTypeName,
      ) || []
    );
  };
      ...
      <div className="space-y-3">
        ...
        {defaultLeaveTypes
          .filter(
            (defaultType: any) =>
              !Array.isArray(leaveTypes) ||
              !leaveTypes.find((lt: any) => lt.name === defaultType.name),
          )
                          ...
                          >
                            ...
                            <div className="flex space-x-2">
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleNavigateToLeaveType(leaveType)
                                }
