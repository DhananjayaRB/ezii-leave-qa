...
export default function Home() {
  ...
  console.log(`[DEBUG] Current org_id from localStorage: ${currentOrgIdForCheck}`);
  ...
  const isSetupCompleted = company && (company as any)?.setupStatus === "completed";
  const isOrgIdMismatch = currentOrgIdForCheck && companyOrgId && currentOrgIdForCheck !== companyOrgId.toString();
  ...
  console.log('[HOME] Condition check: userRole=', userRole, 'needsSetup=', needsSetup);
