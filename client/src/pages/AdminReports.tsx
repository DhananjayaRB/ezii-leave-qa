    ...
    switch (selectedReport) {
      ...
      case "collaborative-leave-report":
        ...
        const getFilteredCollaborativeTasks = () => {
          ...
          console.log(
            "📅 [DATE FILTER] Skipping date filter for collaborative tasks to show all available data",
          );
          ...
          if (selectedTaskStatus !== "all") {
            ...
            console.log(
              `📊 [STATUS FILTER] Filtered ${beforeStatusFilter} → ${filtered.length} tasks for status: ${selectedTaskStatus}`,
            );
          }
          ...
          if (taskAssigneeFilter.trim()) {
            ...
            console.log(
              `👤 [ASSIGNEE FILTER] Filtered ${beforeAssigneeFilter} → ${filtered.length} tasks for filter: ${taskAssigneeFilter}`,
            );
          }
                      ...
                      filteredTasks.map((task: any, index: number) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell className="font-medium">
                              {getEmployeeName(task.leaveRequesterId) ||
                                "Unknown"}
                            </TableCell>
                            <TableCell className="font-medium">
                              {task.assigneeName}
