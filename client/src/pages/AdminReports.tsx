        ...
        const getFilteredCollaborativeTasks = () => {
          ...
          if (dateRange?.from && dateRange?.to) {
            filtered = filtered.filter((task: any) => {
              ...
              return taskDate && taskDate >= dateRange.from && taskDate <= dateRange.to;
            });
          }
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50">
                      ...
                      <TableHead className="font-semibold">Leave Requester</TableHead>
                      ...
                      filteredTasks.map((task: any, index: number) => {
                        ...
                        return (
                          <TableRow key={`task-${task.id}-${index}`} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                            ...
                            <TableCell className="font-medium">
                              {task.leaveRequesterName || `User ${task.leaveRequesterId}` || 'Unknown'}
                            </TableCell>
